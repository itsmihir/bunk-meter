                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      setState(() {
                        ...
                        widget.timetable.lec[i] = Days.timetable[ind].lec[i];
                      });
                    },
                    child: TimeTableCard(
              ...
              children: <Widget>[
                TimeTableCard(
                  ...
                  percentage: widget.timetable.lec[0] == 'null'
                      ...
                      : calculatePercentage(
                          widget.subject.firstWhere((test) =>
                              test.id == widget.timetable.lec[0].substring(1)),
                ...
                TimeTableCard(
                  ...
                  percentage: widget.timetable.lec[1] == 'null'
                      ...
                      : calculatePercentage(
                          widget.subject.firstWhere((test) =>
                              test.id == widget.timetable.lec[1].substring(1)),
                ...
                TimeTableCard(
                  ...
                  percentage: widget.timetable.lec[2] == 'null'
                      ...
                      : calculatePercentage(
                          widget.subject.firstWhere((test) =>
                              test.id == widget.timetable.lec[2].substring(1)),
                ...
                TimeTableCard(
                  ...
                  percentage: widget.timetable.lec[3] == 'null'
                      ...
                      : calculatePercentage(
                          widget.subject.firstWhere((test) =>
                              test.id == widget.timetable.lec[3].substring(1)),
                ...
                TimeTableCard(
                  ...
                  percentage: widget.timetable.lec[4] == 'null'
                      ...
                      : calculatePercentage(
                          widget.subject.firstWhere((test) =>
                              test.id == widget.timetable.lec[4].substring(1)),
                ...
                TimeTableCard(
                  ...
                  percentage: widget.timetable.lec[5] == 'null'
                      ...
                      : calculatePercentage(
                          widget.subject.firstWhere((test) =>
                              test.id == widget.timetable.lec[5].substring(1)),
                ...
                TimeTableCard(
                  ...
                  percentage: widget.timetable.lec[6] == 'null'
                      ...
                      : calculatePercentage(
                          widget.subject.firstWhere((test) =>
                              test.id == widget.timetable.lec[6].substring(1)),
                ...
                TimeTableCard(
                  ...
                  percentage: widget.timetable.lec[7] == 'null'
                      ...
                      : calculatePercentage(
                          widget.subject.firstWhere((test) =>
                              test.id == widget.timetable.lec[7].substring(1)),
